...
if [ "$OPSI" = "1" ]; then
    ...
    in_func == 1 && /^s*{/ {
        ...
        print "            throw new DisplayException("Lu Siapa Mau Delet User Lain Tolol? Izin Dulu Sama Id " admin_id " Kalo Mau Delet©Protect By Aqua V'"'"'"$VERSION"'"'"')");";
        print "        }";
        in_func = 0; next;
    }
    { print }
    ...
    in_func == 1 && /^s*{/ {
        ...
        print "            throw new DisplayException("Lu Siapa Mau Update User Lain Tolol? Izin Dulu Sama Id " admin_id " Kalo Mau Update©Protect By Aqua V'"'"'"$VERSION"'"'"')");";
        print "        }";
        in_func = 0; next;
    }
    { print }
    ...
    in_func == 1 && /^s*{/ {
        ...
        print "            throw new DisplayException("Lu Siapa Mau Delet Server Lain Tolol? Izin Dulu Sama Id " admin_id " Kalo Mau Delet©Protect By Aqua V'"'"'"$VERSION"'"'"')");";
        print "        }";
        in_func = 0; next;
    }
    { print }
